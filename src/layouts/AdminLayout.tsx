...
const navItems = [
  ...
  { icon: Pill, label: 'Pharmacy Delivery', path: '/admin/pharmacy' },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex text-slate-100 font-sans selection:bg-emerald-500/30">
      
      {/* Sidebar background effects */}
      <div className="fixed inset-y-0 left-0 w-64 bg-zinc-900/50 border-r border-white/5 backdrop-blur-xl z-20 hidden md:flex flex-col">
        {/* Logo Area */}
        <div className="h-20 flex items-center px-6 border-b border-white/5">
          <div className="flex items-center gap-3">
             ...
             <span className="text-xl font-bold tracking-tight text-white">DocBoard.</span>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/5">
           <button 
             onClick={logout}
             className="w-full flex items-center gap-3 px-3 py-3 rounded-xl text-red-400 hover:text-red-300 hover:bg-red-400/10 transition-colors font-medium border border-transparent hover:border-red-400/20"
           >
      ...
      <div className="flex-1 md:ml-64 relative min-h-screen">
         ...
         <div className="md:hidden h-16 border-b border-white/5 bg-zinc-900 flex items-center justify-between px-4">
            <span className="font-bold text-lg text-white">DocBoard.</span>
