...
export default function AdminSettings() {
  ...
  return (
    <div className="space-y-8">
       <div>
          <h1 className="text-3xl font-bold tracking-tight text-[var(--text-main)] mb-1">Clinic Settings</h1>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="glass-panel p-6 rounded-2xl flex flex-col gap-6">
             <div className="flex items-center gap-3 border-b border-[var(--border-main)] pb-4">
                ...
                <h2 className="text-xl font-bold text-[var(--text-main)]">Scheduling Rules</h2>
             </div>
             
             <div className="flex items-center justify-between">
                <div>
                   <p className="font-bold text-zinc-200">Enforce Lunch Block</p>
                   <p className="text-xs text-[var(--text-dim)]">Automatically blocks 1:00 PM for all dates globally.</p>
                </div>
                <button 
             ...
             <div className="flex items-center justify-between">
                <div>
                   ...
                   <p className="text-xs text-[var(--text-dim)]">Updates the client portal with current wait times.</p>
                </div>
                <select className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-lg text-[var(--text-main)] text-sm p-2 outline-none">
             ...
             <div className="flex flex-col gap-3">
                ...
                <button 
                  ...
                  className={`mt-2 py-3 px-4 rounded-xl font-bold transition-all text-sm w-max ${
                     ...
                     ? 'bg-red-500 text-[var(--text-main)] animate-pulse shadow-[0_0_20px_rgba(239,68,68,0.5)]' 
          ...
          <div className="glass-panel p-6 rounded-2xl flex flex-col gap-6 md:col-span-2">
             ...
             <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                   ...
                   <p className="text-xs text-[var(--text-dim)] max-w-lg mt-1">
